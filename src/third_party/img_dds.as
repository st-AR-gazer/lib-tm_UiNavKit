...
namespace IMG {
    ...
    namespace _ {
        ...
        int DecompressDXTColorBlock(
            bool isDXT1,
            const string &in sourceData,
            int colorBlockOffset,
            array<uint8> &decompressedBlock
        ) {
            array<uint8> codes(16);
            int a = Unpack565(
                sourceData[colorBlockOffset + 0],
                sourceData[colorBlockOffset + 1],
                codes[0],
                codes[1],
                codes[2]
            );
            int b = Unpack565(
                sourceData[colorBlockOffset + 2],
                sourceData[colorBlockOffset + 3],
                codes[4],
                codes[5],
                codes[6]
            );
        ...
        int DecompressDXT3AlphaBlock(
            const string &in sourceData,
            int alphaBlockOffset,
            array<uint8> &decompressedBlock
        ) {
            for (int i = 0; i < 8; ++i) {
        ...
        int DecompressDXTBlock(
            ...
            return DecompressDXTColorBlock(
        ...
        class DdsPixelFormat {
            ...
            uint FourCC;
            uint RGBBitCount;
            uint get_YUVBitCount() const {
                return RGBBitCount;
            }
            uint get_ZBufferBitDepth() const {
                return RGBBitCount;
            }
            uint get_AlphaBitDepth() const {
                return RGBBitCount;
            }
            uint get_LuminanceBitCount() const {
                return RGBBitCount;
            }
            uint get_BumpBitCount() const {
                return RGBBitCount;
            }
            uint get_PrivateFormatBitCount() const {
                return RGBBitCount;
            }
            uint RBitMask;
            uint get_YBitMask() const {
                return RBitMask;
            }
            uint get_StencilBitDepth() const {
                return RBitMask;
            }
            uint get_LuminanceBitMask() const {
                return RBitMask;
            }
            uint get_BumpDuBitMask() const {
                return RBitMask;
            }
            uint get_Operations() const {
                return RBitMask;
            }
            uint GBitMask;
            uint get_UBitMask() const {
                return GBitMask;
            }
            uint get_ZBitMask() const {
                return GBitMask;
            }
            uint get_BumpDvBitMask() const {
                return GBitMask;
            }
            uint get_FlipAndBltMSTypes() const {
                return GBitMask;
            }
            uint BBitMask;
            uint get_VBitMask() const {
                return BBitMask;
            }
            uint get_StencilBitMask() const {
                return BBitMask;
            }
            uint get_BumpLuminanceBitMask() const {
                return BBitMask;
            }
            uint RGBAlphaBitMask;
            uint get_YUVAlphaBitMask() const {
                return RGBAlphaBitMask;
            }
            uint get_LuminanceAlphaBitMask() const {
                return RGBAlphaBitMask;
            }
            uint get_RGBZBitMask() const {
                return RGBAlphaBitMask;
            }
            uint get_YUVZBitMask() const {
                return RGBAlphaBitMask;
            }
        }
        ...
        class DdsHeader {
            ...
            uint MipMapCount;
            uint get_RefreshRate() const {
                return MipMapCount;
            }
            uint get_SrcVBHandle() const {
                return MipMapCount;
            }
            uint AlphaBitDepth;
            uint Reserved;
            ...
            uint get_EmptyFaceColor() const {
                return CkDestOverlay.ColorSpaceLowValue;
            }
        ...
        RawImage@ DecompressLevel(int mipMapLevel) {
            ...
            case BC7 : {
                    ...
                    if (_Format == CompressedFormat::BC4) {
                        rawImage.Data = _::DecompressBC4Image(
                            _Data,
                            dataOffset,
                            rawImage.Width,
                            rawImage.Height,
                        ...
                        rawImage.Data = _::DecompressBC5Image(
                            _Data,
                            dataOffset,
                            rawImage.Width,
                            rawImage.Height,
                        ...
                        rawImage.Data = _::DecompressBC7Image(
                            _Data,
                            dataOffset,
                            rawImage.Width,
                            rawImage.Height,
                        ...
                        rawImage.Data = _::DecompressDXTImage(
                            _Format,
                            _Data,
                            dataOffset,
                            rawImage.Width,
