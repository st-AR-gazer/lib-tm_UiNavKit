namespace UiNavKit {
    namespace Builder {
        ...
        UiNav::Builder::BuilderDocument@ g_Doc = null;
        int g_SelectedNodeIx = -1;
        int g_BoundsTargetNodeIx = -1;
        array<UiNav::Builder::BuilderDocument@> g_UndoSnapshots;
        array<UiNav::Builder::BuilderDocument@> g_RedoSnapshots;
        ...
        UiNav::Builder::BuilderTypedProps@ _NewTypedProps() {
            return UiNav::Builder::BuilderTypedProps();
        }

        UiNav::Builder::BuilderNode@ _NewNode(const string &in kind, int parentIx = -1) {
        ...
        UiNav::Builder::BuilderDocument@ _NewDocument() {
            auto d = UiNav::Builder::BuilderDocument();
            @d.scriptBlock = UiNav::Builder::BuilderScriptBlock();
            @d.stylesheetBlock = UiNav::Builder::BuilderStylesheetBlock();
            return d;
        }

        void _RebuildNodeIndex(UiNav::Builder::BuilderDocument@ doc) {
        ...
        UiNav::Builder::BuilderTypedProps@ _CloneTypedProps(const UiNav::Builder::BuilderTypedProps@ src) {
            if (src is null) return _NewTypedProps();
            auto outV = UiNav::Builder::BuilderTypedProps();
            outV.size = src.size;
            outV.pos = src.pos;
            outV.z = src.z;
        ...
        UiNav::Builder::BuilderNode@ _CloneNode(const UiNav::Builder::BuilderNode@ src) {
        ...
        UiNav::Builder::BuilderDocument@ _CloneDocument(const UiNav::Builder::BuilderDocument@ src) {
            ...
            for (uint i = 0; i < src.diagnostics.Length; ++i) {
                ...
                auto outD = UiNav::Builder::BuilderDiagnostic();
                outD.code = inD.code;
        ...
        void _ResetDocument(UiNav::Builder::BuilderDocument@ doc) {
        ...
        UiNav::Builder::BuilderNode@ _GetSelectedNode() {
            _EnsureDoc();
